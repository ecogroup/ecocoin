...
void Shutdown(void* parg)
{
    ...
    if (fFirstThread)
    {
        ...
        fExit = true;
#ifndef QT_GUI
        // ensure non-UI client gets exited here, but let ecocoin-qt reach 'return 0;' in bitcoin.cpp
        exit(0);
#endif
    }
    else
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to ecocoind / RPC client
...
int main(int argc, char* argv[])
{
    ...
    // Connect ecocoind signal handlers
    noui_connect();
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 22339 or testnet: 22338)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if(!fTestNet)
        AddOneShot(string("85.25.197.136"));
		AddOneShot(string("188.226.149.172"));
    ...
    // requested to kill ecocoin-qt during the last operation. If so, exit.
