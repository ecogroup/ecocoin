...
# Generated by qmake (2.01a) (Qt 4.8.5) on: ter 15. Abr 21:58:29 2014
# Project:  ecocoin-qt.pro
# Template: app
# Command: c:/Qt/4.8.5/bin/qmake.exe USE_QRCODE=0 BOOST_INCLUDE_PATH=libs/boost_1_54_0 BOOST_LIB_PATH=libs/boost_1_54_0/stage/lib BOOST_LIB_SUFFIX=-mgw46-mt-1_54 OPENSSL_INCLUDE_PATH=libs/openssl-1.0.1e/include OPENSSL_LIB_PATH=libs/openssl-1.0.1e BDB_INCLUDE_PATH=libs/db-4.8.30.NC/build_unix BDB_LIB_PATH=libs/db-4.8.30.NC/build_unix MINIUPNPC_INCLUDE_PATH=libs/miniupnpc-1.8 MINIUPNPC_LIB_PATH=libs/miniupnpc-1.8 QRCODE_INCLUDE_PATH=libs/qrcode-win32-3.1.1/include QRCODE_LIB_PATH=libs/qrcode-win32-3.1.1/dll "QMAKE_CXXFLAGS=-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-function -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing" "QMAKE_CFLAGS=-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-function -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing" -o Makefile ecocoin-qt.pro
#############################################################################
...
Makefile: ecocoin-qt.pro  c:/Qt/4.8.5/mkspecs/default/qmake.conf c:/Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=0 BOOST_INCLUDE_PATH=libs/boost_1_54_0 BOOST_LIB_PATH=libs/boost_1_54_0/stage/lib BOOST_LIB_SUFFIX=-mgw46-mt-1_54 OPENSSL_INCLUDE_PATH=libs/openssl-1.0.1e/include OPENSSL_LIB_PATH=libs/openssl-1.0.1e BDB_INCLUDE_PATH=libs/db-4.8.30.NC/build_unix BDB_LIB_PATH=libs/db-4.8.30.NC/build_unix MINIUPNPC_INCLUDE_PATH=libs/miniupnpc-1.8 MINIUPNPC_LIB_PATH=libs/miniupnpc-1.8 QRCODE_INCLUDE_PATH=libs/qrcode-win32-3.1.1/include QRCODE_LIB_PATH=libs/qrcode-win32-3.1.1/dll "QMAKE_CXXFLAGS=-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-function -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing" "QMAKE_CFLAGS=-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-function -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing" -o Makefile ecocoin-qt.pro
